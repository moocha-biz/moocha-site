  ...
  if (type === 'strawberry') {
    return (
      <svg viewBox="0 0 64 64" width="34" height="34" fill="none">
        ...
        <path d="M23 33q9 6 18 0" stroke="#E8877A" strokeWidth="2.4" fill="none" strokeLinecap="round" />
        <path d="M27 21c-1-3 1-5 4-5M37 21c1-3-1-5-4-5" stroke="#7FAE63" strokeWidth="2" fill="none" strokeLinecap="round" />
      </svg>
    );
  }
  return (
